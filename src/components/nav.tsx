...
const links = [
  ...
  { href: "/accounts", label: "My Accounts", icon: "user" },
  { href: "/influencers", label: "AI Influencers", icon: "star" },
...
export function Nav() {
  ...
  return (
    <aside className="hidden w-64 flex-shrink-0 border-r border-gray-800 bg-gray-900 lg:flex lg:flex-col">
      <div className="flex h-16 items-center gap-2 px-6 text-lg font-bold tracking-tight">
        <span className="text-brand-500">Social</span>Monitor
      </div>
